...
# Password reset URLs
    ...
    path('api/coffee-shops/<int:coffee_shop_id>/menu-items/<int:pk>/remove-primary-image/',
         MenuItemViewSet.as_view({'delete': 'remove_primary_image'}),
         name='menu-item-remove-primary-image'),
    path('api/coffee-shops/<int:coffee_shop_id>/menu-items/<int:pk>/remove-additional-image/<int:image_id>/',
         MenuItemViewSet.as_view({'delete': 'remove_additional_image'}),
         name='menu-item-remove-additional-image'),
    path('api/coffee-shops/<int:coffee_shop_id>/menu-items/<int:pk>/sizes/<int:size_id>/',
         MenuItemViewSet.as_view({'delete': 'remove_size'}),
         name='menu-item-remove-size'),
